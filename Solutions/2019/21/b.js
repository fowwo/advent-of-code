...
computer.input.push(...ascii("OR E T")); // Jump early if possible (1)
computer.input.push(...ascii("OR H T"));
computer.input.push(...ascii("NOT C J"));
computer.input.push(...ascii("AND T J"));
computer.input.push(...ascii("AND J T")); // Reset T
computer.input.push(...ascii("OR B T")); // Jump early if possible (2)
computer.input.push(...ascii("OR E T"));
computer.input.push(...ascii("NOT T T"));
