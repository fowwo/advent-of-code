	...
	for (var j = 0; j < b.length; j++){
		...
		if (a[i].y[0] == a[i].y[1] && b[j].x[0] == b[j].x[1]){        // ---  |
			if (((a[i].y[0] < b[j].y[0] && a[i].y[0] > b[j].y[1]) || (a[i].y[0] > b[j].y[0] && a[i].y[0] < b[j].y[1])) && ((b[j].x[0] > a[i].x[0] && b[j].x[0] < a[i].x[1]) || (b[j].x[0] < a[i].x[0] && b[j].x[0] > a[i].x[1]))){
				int.push(Math.abs(a[i].y[0]) + Math.abs(b[j].x[0]));
			}
			...
			if (((a[i].x[0] < b[j].x[0] && a[i].x[0] > b[j].x[1]) || (a[i].x[0] > b[j].x[0] && a[i].x[0] < b[j].x[1])) && ((b[j].y[0] > a[i].y[0] && b[j].y[0] < a[i].y[1]) || (b[j].y[0] < a[i].y[0] && b[j].y[0] > a[i].y[1]))){
				int.push(Math.abs(a[i].x[0]) + Math.abs(b[j].y[0]));
			}
		}
	}
}
...
console.log("The Manhattan distance to the closest intersection: " + int[0]);
