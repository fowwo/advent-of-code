	...
	public static void main(String[] args){
		...
		while (intArr.get(x) != 99){
			if (intArr.get(x) == 1){
				...
				intArr.set(intArr.get(x + 3), intArr.get(intArr.get(x + 1)) * intArr.get(intArr.get(x + 2)));
				x += 4;
			} else if (intArr.get(x) == 3){
				intArr.set(intArr.get(x + 1), inputValue);
				x += 2;
			} else if (intArr.get(x) == 4){
				System.out.println(intArr.get(intArr.get(x + 1)));
				x += 2;
			} else if (intArr.get(x) == 1001){
				intArr.set(intArr.get(x + 3), intArr.get(intArr.get(x + 1)) + intArr.get(x + 2));
				x += 4;
			} else if (intArr.get(x) == 1002){
				intArr.set(intArr.get(x + 3), intArr.get(intArr.get(x + 1)) * intArr.get(x + 2));
				x += 4;
			} else if (intArr.get(x) == 1101){
				intArr.set(intArr.get(x + 3), intArr.get(x + 1) + intArr.get(x + 2));
				x += 4;
			} else if (intArr.get(x) == 1102){
				intArr.set(intArr.get(x + 3), intArr.get(x + 1) * intArr.get(x + 2));
				x += 4;
			} else if (intArr.get(x) == 101){
				intArr.set(intArr.get(x + 3), intArr.get(x + 1) + intArr.get(intArr.get(x + 2)));
				x += 4;
			} else if (intArr.get(x) == 102){
				intArr.set(intArr.get(x + 3), intArr.get(x + 1) * intArr.get(intArr.get(x + 2)));
				x += 4;
			} else if (intArr.get(x) == 104){
				System.out.println(intArr.get(x + 1));
				x += 2;
			} else {
				System.out.println("Something went wrong! intArr.get(x) = " + intArr.get(x) + "; x = " + x);
				break;
			}
		}
	}
