...
_ t1 t2 _ _ p1 p2 p3 p4 p5 p6 _ _ _ _ n1 n2 _ _ loop d1 d2 d3 d4 _ _ _ 1
>>>>>->->->->->->>>>>>>>>>>>>>>>>+<<<<<<<
...
,>+<[>-]>[-<++++++++++>>]<<----------[       Read next number
  ...
  [->>>>>>>>+<<<<<<<<]>[->>>>>+<<<<<]                               Move fourth previous number for comparison
  >[-<<+>>]>[-<<+>>]>[-<<+>>]>[-<<+>>]                              Shift remaining previous numbers back
