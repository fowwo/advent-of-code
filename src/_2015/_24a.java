...
public class _24a {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            File f = new File("input/2015/24.txt");
        ...
        // Find all combinations whose sum a third of the total sum
        List<List<Integer>> combinations = findAllCombinationsWithSum(weights, sum / 3);
